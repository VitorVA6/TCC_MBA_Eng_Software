...
describe('LedgerReconciliationService', () => {
  ...
  it('12. should identify amount mismatch even for duplicated bank entries', async () => {
    const internalEntries: InternalEntry[] = [
    ...
    expect(result.duplicatedBank).toEqual(['PAY-001']);
    expect(result.amountMismatch).toEqual(['PAY-001']);
