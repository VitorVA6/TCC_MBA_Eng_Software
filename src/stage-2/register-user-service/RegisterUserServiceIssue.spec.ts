import { RegisterUserService } from '../register-user-service/correct'
import { UserRepository, EmailService } from '../../stage-1/register-user-service/contract/interfaces'
...
describe('RegisterUserService', () => {
  ...
  describe('execute', () => {
    ...
    it('should throw an error when email format is invalid', async () => {
      // faltou mockar o findByEmail
      const input = { name: 'John Doe', email: 'johnexample.com' };
